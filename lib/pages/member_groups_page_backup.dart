...
class _MemberGroupsPageState extends State<MemberGroupsPage>
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: _buildStatCard(
              'Disponibles',
              _availableGroups.length.toString(),
              Icons.explore,
  ...
  Widget _buildProfessionalTabButton(String tabId, String title, IconData icon, int count) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildProfessionalGroupCard(group, isMyGroup: true);
        },
      ),
    );
  }
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return _buildProfessionalGroupCard(group, isMyGroup: false);
        },
      ),
    );
  }
