...
class _SongProjectionPageState extends State<SongProjectionPage> {
  ...
  Color _bgColor = AppTheme.black100;
  Color _textColor = AppTheme.white100;
  double _fontSize = 24;
  ...
  String _colorToString(Color color) {
    if (color == AppTheme.black100) return 'black';
    if (color == AppTheme.white100) return 'white';
  ...
  Color _colorFromString(String colorString) {
    switch (colorString) {
      case 'white': return AppTheme.white100;
      case 'yellow': return Colors.yellowAccent;
      default: return AppTheme.black100;
    }
  }
    ...
    return [
      ...
      PopupMenuButton<String>(
        ...
        onSelected: (value) {
          setState(() {
            if (value == 'noir') {
              _bgColor = AppTheme.black100;
              _textColor = AppTheme.white100;
              _highContrast = false;
            } else if (value == 'blanc') {
              _bgColor = AppTheme.white100;
              _textColor = AppTheme.black100;
              _highContrast = false;
          ...
          return Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                ...
                height: 1.5,
                fontFamily: _fontFamily,
                fontWeight: _highContrast ? AppTheme.fontBold : FontWeight.normal,
