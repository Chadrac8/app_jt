...
class ModuleConfig {
  ...
  final double coverImageHeight; // Hauteur de l'image de couverture en pixels
  ...
  ModuleConfig({
    ...
    this.coverImageHeight = 200.0, // Hauteur par défaut
  });
  ...
  factory ModuleConfig.fromFirestore(DocumentSnapshot doc) {
    ...
    return ModuleConfig(
      ...
      coverImageHeight: (data['coverImageHeight'] as num?)?.toDouble() ?? 200.0,
    );
  }
  ...
  ModuleConfig copyWith({
    ...
    return ModuleConfig(
      ...
      showCoverImage: showCoverImage ?? this.showCoverImage,
      coverImageHeight: coverImageHeight ?? this.coverImageHeight,
    );
  }
}
  ...
  factory AppConfigModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return AppConfigModel(
      ...
      modules: modulesData.map((m) => ModuleConfig(
        ...
        showCoverImage: m['showCoverImage'] ?? false,
        coverImageHeight: (m['coverImageHeight'] as num?)?.toDouble() ?? 200.0,
      )).toList(),
  ...
  Map<String, dynamic> toFirestore() {
    return {
      'modules': modules.map((m) => {
        ...
        'coverImageUrl': m.coverImageUrl,
        'showCoverImage': m.showCoverImage,
        'coverImageHeight': m.coverImageHeight,
      }).toList(),
