...
class _BibleArticlesListViewState extends State<BibleArticlesListView> {
  ...
  void _navigateToArticleDetail(BibleArticle article) {
    ...
    ).then((_) => _loadArticles()); // Recharger après retour
  }
  ...
  void _navigateToCreateArticle() {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => const BibleArticleFormView(),
      ),
    ).then((_) => _loadArticles()); // Recharger après création
  }
    ...
    switch (action) {
      case 'edit':
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => BibleArticleFormView(article: article),
          ),
