...
class MemberSongsPageMD3 extends StatefulWidget {
  ...
  const MemberSongsPageMD3({super.key, this.onToggleSearchChanged});

  @override
  State<MemberSongsPageMD3> createState() => _MemberSongsPageMD3State();
}

class _MemberSongsPageMD3State extends State<MemberSongsPageMD3>
