...
import '../../../pages/song_form_page.dart';
...
class _SongsHomePageState extends State<SongsHomePage>
            ...
            IconButton(
              ...
              onPressed: () {
                if (_tabController.index == 1) {
                  _navigateToSetlistForm();
                } else {
                  _navigateToSongForm();
                }
              },
              tooltip: _tabController.index == 1 ? 'Ajouter une setlist' : 'Ajouter un chant',
            ),
          ],
        ],
        bottom: TabBar(
  ...
  Widget _buildSongsTab() {
    return StreamBuilder<List<SongModel>>(
      stream: SongsFirebaseService.advancedSearchSongs(
        text: _searchQuery,
                    ...
                    ElevatedButton.icon(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const SetlistStatisticsPage(),
                          ),
                        );
                      },
                    ),
