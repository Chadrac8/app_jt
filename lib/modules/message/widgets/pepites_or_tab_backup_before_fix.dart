...
class _PepitesOrTabState extends State<PepitesOrTab> with TickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              child: Row(
                children: _availableThemes.map((theme) {
                  return Padding(
                    ...
                    child: _buildCompactFilterChip(theme),
                  );
                }).toList(),
              ),
            ),
          ...
          if (_isSearching) const SizedBox(height: AppTheme.space20),

          // Bouton de recherche si non en mode recherche
          if (!_isSearching)
            Container(
              margin: const EdgeInsets.symmetric(horizontal: 20),
  ...
  Widget _buildCompactFilterChip(String theme) {
    ...
    Color getFilterColor() {
      switch (theme) {
        case 'Foi':
          return const AppTheme.successColorBright;
        case 'Amour':
