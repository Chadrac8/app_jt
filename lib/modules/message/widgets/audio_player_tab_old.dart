  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: RefreshIndicator(
        onRefresh: () => _loadSermons(forceRefresh: true),
        child: Column(
          children: [
            // Player principal (toujours visible)
            _buildMainPlayer(),
            
            // Barre de recherche et filtres (déplacée ici)
  ...
  Widget _buildSearchAndFilters() {
    return Container(
      ...
      child: Column(
        children: [
          if (_isSearching) ...[
            // Mode recherche : afficher la barre de recherche
            Row(
              children: [
                Expanded(
                  child: TextField(
        ...
        leading: Stack(
          children: [
            Container(
              ...
              child: Icon(
                Icons.headphones,
                color: isCurrentSermon ? AppTheme.primaryColor : AppTheme.textSecondaryColor,
              ),
            ),
